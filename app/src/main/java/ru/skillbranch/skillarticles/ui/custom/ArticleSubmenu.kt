...
class ArticleSubmenu @JvmOverloads constructor(
    ...
    private var binding = LayoutSubmenuBinding.inflate(LayoutInflater.from(context), this, true)

    val btnTextDown
        get() = binding.btnTextDown

    val btnTextUp
        get() = binding.btnTextUp

    val switchMode
        get() = binding.switchMode
